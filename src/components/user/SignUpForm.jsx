...
const SignUpForm = () => {
  ...
  const formData = async (e) => {
    ...
    if (IsEmpty(data.first_name) || IsEmpty(data.last_name)) {
      ...
      {
        res.status === "failed" && ErrorToast(res.data);
      }
    }
  };
    ...
    <div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 mb-10">
      ...
      <form className="space-y-6">
        <div className="space-y-1 text-sm">
          <label htmlFor="first_name" className="block dark:text-gray-600">
          First Name
          </label>
          <input
            type="text"
        ...
        <div className="space-y-1 text-sm">
          <label htmlFor="last_name" className="block dark:text-gray-600">
            Last Name
          </label>
          <input
            type="text"
